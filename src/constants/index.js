...
export const EXPERIENCES = [
  {
    ...
    company: "75Techstore.",
    description: `Led a team in developing and maintaining web applications using JavaScript, React.js, and Tailwind. Implemented RESTful APIs. Collaborated with stakeholders to define project requirements and timelines.`,
  ...
  },
  {
    ...
    Designed and implemented efficient data collection protocols, ensuring high-quality data.
    Developed secure digital database architectures, safeguarding against data breaches and loss.`,
    technologies: ["Microsoft office", "Google workspace", "Notion",],
  },
];
...
export const CONTACT = {
  address: "7c Akin Laguda Adeniyi Jones, Ikeja ",
  phoneNo: "+234 7035 6207 09 ",
  email: "osazuwaikhinmwin5@gmail.com",
};
